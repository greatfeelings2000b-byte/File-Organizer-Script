...
def main():
    ...
    # so this is the optimised way of doing things where we did not store the names of the files inside the seperate list thus reducing 
    # the space complexity upto O(n) plus it is much much cleaner code then before
